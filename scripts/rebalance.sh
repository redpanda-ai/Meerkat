curl -XPUT n10001:9200/_cluster/settings -d '{ "transient" : { "cluster.routing.allocation.balance.primary": 1.00 } }'
curl -XPUT n10001:9200/_cluster/settings -d '{ "transient" : { "cluster.routing.allocation.balance.threshold": 0.5 } }'
curl -XPUT n10001:9200/_cluster/settings -d '{ "transient" : { "cluster.routing.allocation.balance.index": 1.0 } }'
curl -XPUT n10001:9200/_cluster/settings -d '{ "transient" : { "cluster.routing.allocation.cluster_concurrent_rebalance": -1 } }'
