"""This module loads in Wal-mart store numbers."""
...
def start():
	...
	browser = Browser()
	base_url = "http://www.walmart.com/storeLocator/"\
		"ca_storefinder_details_short.do?edit_object_id="
	current_walmart = 1755
	found = []
	save_file = open(\
		"../../data/misc/Store\ Numbers/Clean/walmart_store_numbers.txt", "a")
