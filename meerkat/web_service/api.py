...
class Meerkat_Datadeal_API(APIHandler):
	...
	with open(base_dir + "example_input_datadeal.json") as data_file:
	...
	with open(base_dir + "example_output_datadeal.json") as data_file:
	...
	with open(base_dir + "example_debug_output_datadeal.json") as data_file:
